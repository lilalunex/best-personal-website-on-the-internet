...
<div class="container mx-auto px-8 text-color-ctrl">
	...
	<p class="pt-4">
		...
		we are not obligated to monitor transmitted or stored external information or to investigate
		circumstances that indicate illegal activity.<br><br>
	...
	<p class="pt-4">
		...
		Abs.
		1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis
		10
