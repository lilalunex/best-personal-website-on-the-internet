    ...
    <div class="container mx-auto py-8 md:py-16 px-8">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 pt-8">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <a href="http://dukkart.de" class="bg-muted-sand border-deeper-brown border-2 rounded-xl px-8 py-4 mt-4"
                   target="_blank"
                   rel="noopener noreferrer">Photograpy-Website</a>
                <a href="http://dreamstudiobadoeynhausen.de"
                   class="bg-muted-sand border-deeper-brown border-2 rounded-xl px-8 py-4 mt-4" target="_blank"
                   rel="noopener noreferrer">Rental-Studio</a>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 pt-16 pb-8">
            <div class="flex flex-col justify-center items-center order-2 xl:order-1">
                ...
                <a href="https://shibuy.art/" class="bg-muted-sand border-deeper-brown border-2 rounded-xl px-8 py-4 mt-4"
                   target="_blank"
                   rel="noopener noreferrer">Art-Website</a>
                <a href="https://www.instagram.com/salvador_jaxon/"
                   class="bg-muted-sand border-deeper-brown border-2 rounded-xl px-8 py-4 mt-4"
                   target="_blank"
                   rel="noopener noreferrer">Instagram</a>
            </div>
