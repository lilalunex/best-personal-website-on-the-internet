                ...
                {#if showCV}
                    <div class="ml-8" transition:fade>
                        <a href="/downloads/CV.pdf">
                            <img src="/meta/usa.png" alt="American Language" class="ml-2 lang inline border-rounded">
                        </a>
                        <a href="/downloads/CV_GER.pdf">
                            <img src="/meta/ger.png" alt="German Language" class="ml-2 lang inline border-rounded">
                        </a>
                    </div>
                {/if}
            </div>
