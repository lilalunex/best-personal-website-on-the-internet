    ...
    <div class="bg-warm-beige dark:bg-darkreader-warm-beige text-earthy-brown dark:text-darkreader-earthy-brown">
        <div class="container mx-auto py-8 md:py-16 px-8">
            ...
            <p class="pt-8 text-center">
                I couldn't manage to get remix running on the path /2024/.<br>
                So... here are two images:
            </p>

            <div class="container mx-auto pt-8 pb-4 md:py-8 grid grid-cols-1 gap-8">
                <a href="/lilalunex_2024/desktop.png"><img src="/lilalunex_2024/desktop.png" alt="One Handed Mobile Menu 1" loading="lazy" class="rounded-xl mx-auto"/></a>
                <a href="/lilalunex_2024/mobile.png"><img src="/lilalunex_2024/mobile.png" alt="One Handed Mobile Menu 2" loading="lazy" class="rounded-xl mx-auto"/></a>
            </div>
